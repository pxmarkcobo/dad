export default function Registration() {
  return (
    <section className="col-span-3 antialiased dark:bg-gray-900 md:py-16">
        ...
        <ol className="items-nter flex w-full max-w-2xl text-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:text-base">
          <li className="after:border-1 text-primary-700 dark:text-primary-500 flex items-center after:mx-6 after:hidden after:h-1 after:w-full after:border-b after:border-gray-200 dark:after:border-gray-700 sm:after:inline-block sm:after:content-[''] md:w-full xl:after:mx-10">
            <span className="flex items-center after:mx-2 after:text-gray-200 after:content-['/'] dark:after:text-gray-500 sm:after:hidden">
              <svg
                className="me-2 size-4 sm:size-5"
                aria-hidden="true"
          ...
          <div className="min-w-0 flex-1 space-y-8">
                  ...
                  <div className="flex items-start">
                    <div className="flex h-5 items-center">
                      <input
                        ...
                        name="payment-method"
                        value=""
                        className="text-primary-600 focus:ring-primary-600 dark:focus:ring-primary-600 size-4 border-gray-300 bg-white focus:ring-2 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800"
                        checked
                      />
                    </div>
            ...
            <div>
              ...
              <div className="flex max-w-md items-center gap-4">
                ...
                <button
                  type="button"
                  className="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 flex items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4"
                >
                  Apply
                </button>
              </div>
